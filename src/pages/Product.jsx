...
const Product = () => {
  ...
  return (
    ...
    <Card img={image} tit='shoes' des='comfortable'/>
    <Card img={image1}  tit='shoes' des='comfortable'/>
    <Card img={image2}  tit='shoes' des='comfortable'/>
    <Card img={image3} tit='shoes' des='comfortable'/>
    <Card img={image4}  tit='shoes' des='comfortable'/>
    <Card img={image5}  tit='shoes' des='comfortable'/>
    <Card img={image6}  tit='shoes' des='comfortable'/>
    <Card img={image7}  tit='shoes' des='comfortable'/>
    <Card img={image8}  tit='shoes' des='comfortable'/>
    <Card img={image9}  tit='shoes' des='comfortable'/>
    </div>
    </>
  )
}
